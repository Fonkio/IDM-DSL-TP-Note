 ...
 * </p>
 * <ul>
 *   <li>{@link maisonDeDisque.impl.PersonneImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PersonneImpl extends MinimalEObjectImpl.Container implements Personne {
	...
	protected EClass eStaticClass() {
		return MaisonDeDisquePackage.Literals.PERSONNE;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MaisonDeDisquePackage.PERSONNE__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MaisonDeDisquePackage.PERSONNE__NAME:
				return getName();
		}
