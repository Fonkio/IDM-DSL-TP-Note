 ...
 * @generated
 */
public class MaisonDeDisqueSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case MaisonDeDisquePackage.MAISON_DE_DISQUE: {
				MaisonDeDisque maisonDeDisque = (MaisonDeDisque)theEObject;
				T result = caseMaisonDeDisque(maisonDeDisque);
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Maison De Disque</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Maison De Disque</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseMaisonDeDisque(MaisonDeDisque object) {
		return null;
	}
